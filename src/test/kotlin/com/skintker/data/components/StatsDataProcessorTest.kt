...
//
//    private val pCorrelation = mockk<PearsonsCorrelation>()
////    private val anova = mockk<OneWayAnova>()
//    private val processor = StatsDataProcessor(pCorrelation,OneWayAnova())
//
//    //TODO: add tests mocking the OneWayAnova and other ones using the real values to check if any exception is raised
//
//    @Test
...
//    fun aaaaa(){
//
//        processor.isWeatherTemperatureInvolved(
//            LogsStatsData(
//                irritationLevels = listOf(10, 8, 8, 10, 10, 8),
//                temperatureLevels = listOf(4, 5, 3, 5, 5, 3)
//                )
//
//        )
//    }
...
////        )
////
////        val causes = processor.isStressInvolved(map, 6, 0.6f)
////
...
//        )
//
//        val cause = processor.isAlcoholInvolved(beerTypeMap, alcoholMap, 0.7f)
//
